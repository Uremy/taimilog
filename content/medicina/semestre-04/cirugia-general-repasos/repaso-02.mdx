...
<Step>
#### Analgesia
Corresponde a la analgesia y amnesia iniciales, donde el paciente aún responde a comandos.
</Step>
<Step>
#### Excitación o delirio
Es una fase crítica y peligrosa caracterizada por hiperactividad simpática, respiración irregular y un altísimo riesgo de laringoespasmo o vómito.
</Step>
<Step>
#### Anestesia quirúrgica
La anestesia quirúrgica propiamente dicha, donde se deprimen los reflejos somáticos y autonómicos, permitiendo la incisión; esta etapa se subdivide en cuatro planos según la relajación muscular y el cese de los movimientos oculares.
</Step>
<Step>
#### Parálisis bulbar
Representa la sobredosis letal con colapso cardiovascular y paro respiratorio.
</Step>
</Steps>

En la práctica clínica moderna, la inducción rápida con fármacos intravenosos permite saltar la peligrosa etapa de excitación en cuestión de segundos, llevando al paciente directamente al plano quirúrgico seguro.
...
<TypeTable
  type={{
    "ASA I": { description: "Paciente completamente sano, sin enfermedades agudas o crónicas.", type: "Riesgo Normal" },
    "ASA II": { description: "Paciente con enfermedad sistémica leve bien controlada y sin limitación funcional (fumadores, embarazadas sanas, HAS controlada).", type: "Riesgo Leve" },
    "ASA III": { description: "Enfermedad sistémica grave con limitación funcional definitiva (DM descompensada, obesidad mórbida, IAM > 3 meses).", type: "Riesgo Alto" },
    "ASA IV": { description: "Enfermedad sistémica grave que representa una amenaza constante para la vida (IC severa, sepsis, IAM < 3 meses).", type: "Riesgo Muy Alto" },
    "ASA V": { description: "Paciente moribundo, supervivencia no esperada > 24h sin cirugía (ruptura de aneurisma aórtico).", type: "Riesgo Extremo" },
    "ASA VI": { description: "Muerte encefálica declarada (extracción de órganos para donación).", type: "Muerte Cerebral" },
  }}
/>

Además, si cualquier intervención debe realizarse de emergencia sin el tiempo adecuado de preparación, se añade el sufijo "E" a la categoría correspondiente, lo cual incrementa estadísticamente el riesgo global.
...
### Transoperatorio
El monitoreo quirúrgico estándar exige tener siempre a la vista el electrocardiograma continuo, la oximetría de pulso, la presión arterial (no invasiva o invasiva según la gravedad), la temperatura central y la medición estricta de la uresis con sonda. Sumado a esto, la capnografía es innegociable, ya que es el estándar de oro para confirmar la correcta ventilación. Las posiciones quirúrgicas facilitan la exposición, pero traen riesgos propios; el decúbito supino es el más noble, la posición de Trendelenburg (cabeza abajo) es genial para cirugía pélendo pero aumenta la presión intracraneal y dificulta que los pulmones se expandan, la posición en prono requiere protección extrema de las zonas de presión faciales y oculares, y la de litotomía (piernas en estribos) tiene el clásico riesgo de lesionar el nervio peroneo si se prolonga. Las complicaciones transoperatorias más urgentes que debes vigilar incluyen la hemorragia aguda y el choque hipovolémico, arritmias inducidas por tracción de vísceras o fármacos, y la hipotermia, que altera cascadas de coagulación y favorece el sangrado.

### Posoperatorio
Cuidar a un paciente posquirúrgico depende de cómo escribes tus indicaciones para enfermería, las cuales siempre deben llevar un orden lógico y universal. 

<Steps>
<Step>
#### Dieta
Ya sea mantener el ayuno hasta que haya peristalsis o iniciar progresión a líquidos claros.
</Step>
<Step>
#### Soluciones parenterales
Calculando los requerimientos basales de líquidos y reponiendo el sangrado o fluidos perdidos en quirófano.
</Step>
<Step>
#### Medicamentos
Asegurando un esquema de analgesia escalonada, antieméticos para evitar que el paciente vomite y lastime la herida, y los antibióticos, siempre anotando la presentación, dosis exacta, vía y horario.
</Step>
<Step>
#### Medidas generales
Donde instruyes cada cuánto tomar signos vitales, los cuidados de la herida quirúrgica, la cuantificación de drenajes, los cuidados de sondas y la indicación de levantarse y caminar lo antes posible para evitar trombos.
</Step>
</Steps>

Finalmente, para predecir las complicaciones postoperatorias, debes buscar las famosas causas de fiebre aguda: atelectasias pulmonares en las primeras cuarenta y ocho horas, infecciones urinarias asociadas a la sonda, infecciones del sitio quirúrgico hacia el quinto o séptimo día, y el riesgo latente de trombosis venosa profunda. Además de la fiebre, debes vigilar estrictamente que la herida no presente sangrado activo o dehiscencia de suturas y que los intestinos despierten, evitando un íleo paralítico prolongado.
...
* **Identificación por pH:** ¿Es acidosis (< 7.35) o alcalosis (> 7.45)?
* **Identificación del origen:** Si el pH es ácido y el $CO_2$ está alto (> 45 mmHg), es **respiratoria**. Si el pH es ácido y el $HCO_3^-$ está bajo (< 22 mEq/L), es **metabólica**. (Y viceversa para la alcalosis).
* **Análisis de compensación:** El cuerpo siempre intenta compensar con el sistema opuesto. Si es acidosis metabólica, el paciente hiperventila para bajar el $CO_2$. Si la compensación no es la esperada matemáticamente, estás ante un trastorno mixto.
...
* **Anion Gap Elevado (> 12 mEq/L):** Hay un ácido fantasma sumando carga. Nemotecnia MUDPILES (Metanol, Uremia, Cetoacidosis Diabética, Propilenglicol, Infección/Isoniazida, Ácido Láctico, Etilenglicol, Salicilatos). En cirugía general, **el lactato por choque o isquemia intestinal** es la causa de mayor impacto.

* **Trastornos Mixtos:** Ocurren cuando hay dos o más alteraciones primarias simultáneas. Ejemplo: Paciente con sepsis abdominal (acidosis metabólica por lactato) que además está vomitando sin parar (alcalosis metabólica por pérdida de $HCl$ del estómago). El pH puede salir normal, pero el bicarbonato y el $CO_2$ estarán por las nubes o por los suelos, y el Anion Gap estará alterado.
...
#### Cómo reponerlos e indicarlos en piso
...
Para fines de simplificación, la RMT se divide clásicamente en dos fases principales, más una tercera de recuperación:

<Tabs items={['Fase Ebb', 'Fase Flow', 'Fase Anabólica']}>
<Tab value="Fase Ebb">
**Fase de Reflujo, Choque o Hipodinámica.**
...
* **¿Qué le pasa al paciente?** Todo disminuye. Cae el gasto cardíaco (hipoperfusión), disminuye el consumo de oxígeno, baja la temperatura corporal (hipotermia) y disminuye la tasa metabólica basal.
* Hay una liberación masiva de catecolaminas para hacer vasoconstricción y tratar de mantener la presión arterial.
</Tab>
<Tab value="Fase Flow">
**Fase de Flujo o Hiperdinámica.**
...
* **¿Qué le pasa al paciente?** Todo se acelera a niveles tóxicos. Es la fase del hipermetabolismo y el hipercatabolismo. Aumenta el gasto cardíaco, aumenta drásticamente el consumo de oxígeno y sube la temperatura (fiebre postoperatoria).
...
*   **Carbohidratos (Hígado):** Las reservas de glucógeno hepático se agotan en 12 a 24 horas. El hígado empieza a hacer gluconeogénesis masiva.
*   **Lípidos (Tejido adiposo):** Se activa la lipólisis. Los triglicéridos se rompen en ácidos grasos libres (para darle energía a los músculos) y glicerol (para que el hígado haga más glucosa).
*   **Proteínas (Músculo):** El cuerpo canibaliza el músculo esquelético (proteólisis) para liberar aminoácidos, especialmente **alanina y glutamina**. La glutamina es el alimento principal de los enterocitos y del sistema inmune.
...
*   La bomba muscular (los gemelos de la pierna exprimen las venas al caminar).
*   La bomba respiratoria (al inspirar, creas presión negativa en el tórax que "chupa" la sangre hacia el corazón).
...
#### Fase de Reparación
*   Empieza a solaparse alrededor del **tercer o cuarto día**. El cambio ocurre cuando los macrófagos cambian su perfil químico: dejan de escupir citocinas destructivas (M1) y empiezan a secretar **TGF-β y VEGF** (perfil M2), que son las órdenes de construcción.
...
*   **Aguda:** Es la respuesta inmediata. Clínicamente domina el edema y los neutrófilos. En tiempos estrictos, **dura desde los primeros minutos hasta los cuatro o siete días (una semana)**. Si al cuarto día el paciente sigue con los picos de inflamación al máximo, algo está mal (posible infección agregada).
*   **Subaguda:** Es la "zona gris" temporal y clínica. Se considera subaguda aquella que dura **desde la primera semana (día 7) hasta las cuatro a seis semanas**. A nivel celular, los macrófagos y los primeros linfocitos están dominando, pero aún hay signos clínicos de actividad inflamatoria.
*   **Crónica:** El Colegio y los consensos quirúrgicos marcan la frontera de la cronicidad en **más de seis semanas**. Puede durar meses o años. 
...
El ácido araquidónico es un ácido graso de veinte carbonos que vive escondido en los fosfolípidos de las membranas celulares. Cuando hay trauma, la enzima **Fosfolipasa A2** lo libera, y de ahí puede tomar dos caminos metabólicos.

```mermaid
flowchart TD
    A["Fosfolípidos de Membrana"] -->|"Fosfolipasa A2 <br/> Inhibida por Corticoides"| B("Ácido Araquidónico")
    
    B -->|"Ciclooxigenasa COX-1 y COX-2 <br/> Inhibidas por AINEs"| C["Vía de las Prostaglandinas"]
...
El PAF también deriva de los fosfolípidos de membrana, pero tiene un poder enorme, mucho mayor que la histamina para causar dilatación vascular y fuga de líquidos.
...
<Accordion title="Patrones de Inflamación Aguda">
Se caracterizan por alteraciones vasculares, edema y predominio absoluto de neutrófilos.
* **Serosa:** Acumulación de líquido pobre en células (transudado o exudado muy leve). Ejemplo: Ampollas cutáneas por quemaduras térmicas en cirugía de trauma.
* **Fibrinosa:** Daño vascular severo que deja escapar fibrinógeno, formando una red de fibrina gruesa. Clínicamente relevante en cavidades (pleura, pericardio, peritoneo). Si no se limpia, los fibroblastos la colonizan y se forman **adherencias quirúrgicas** o bridas.
* **Supurativa o Purulenta:** Presencia masiva de pus (neutrófilos muertos y bacterias). Ejemplo: Apendicitis aguda abscedada.
* **Ulcerosa:** Excavación local en la superficie de un órgano o mucosa por necrosis y desprendimiento del tejido inflamado.
</Accordion>
<Accordion title="Patrones de Inflamación Crónica">
