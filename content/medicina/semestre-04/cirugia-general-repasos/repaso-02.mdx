...
Aquí tienes la segunda mitad, estructurada exactamente como la pediste y enfocada en lo que realmente te servirá tanto para el examen escrito como para entender por qué recetamos ciertos medicamentos en el postoperatorio.

---

### 3.2.1.4 Mediadores químicos de la inflamación

Los mediadores químicos son las señales que encienden, amplifican o apagan la respuesta inflamatoria. Pueden derivar del plasma (como el sistema del complemento o la coagulación) o de las células (como los que veremos a continuación).

#### 1. Metabolitos del Ácido Araquidónico (Eicosanoides)
...
graph TD
    ...
    classDef enzima fill:#f9f,stroke:#333,stroke-width:2px;
    class A,B,C,D enzima;
```


**Explicación clínica de los metabolitos:**
*   **Vía de la Ciclooxigenasa (COX):**
    *   **Prostaglandinas (PGE2, PGD2):** Son las reinas del **dolor y la fiebre**. Causan vasodilatación masiva. *Dato clave:* Por eso damos AINEs (Ketorolaco, Ibuprofeno), porque bloquean a la COX y apagan esta vía.
...
*   **Vía de la Lipooxigenasa (LOX):**
    *   **LTB4:** Es un imán biológico. Hace **quimiotaxis** pura, atrayendo a los neutrófilos al sitio de la herida.
...
Las citocinas son proteínas secretadas por células (principalmente macrófagos y linfocitos) que modulan la función de otras células. Las quimiocinas son una subfamilia diseñada exclusivamente para atraer células (quimiotaxis).

| Mediador | Fuente Principal | Función Principal (Enfoque Quirúrgico) |
| :--- | :--- | :--- |
...
### 3.2.2 Patrones morfológicos de la inflamación aguda/crónica
...
1.  **Crónica Inespecífica:**
    *   No hay un patrón celular especial, solo una "sopa" de macrófagos y linfocitos destruyendo y reparando al mismo tiempo, lo que genera paredes engrosadas y duras por la fibrosis.
...
2.  **Crónica Granulomatosa (El dato de oro):**
