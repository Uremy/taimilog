...
* **El Anion Gap (Brecha Aniónica):** Solo se calcula en la **acidosis metabólica**. Sirve para saber si la acidosis es por ganancia de ácidos (como ácido láctico o cetoácidos) o por pérdida de bicarbonato (como diarrea). La fórmula es:
    $AG = Na^+ - (Cl^- + HCO_3^-)$
