...
3.  **Proteínas (Músculo):** **Esta es la clave.** El cuerpo canibaliza el músculo esquelético (proteólisis) para liberar aminoácidos, especialmente **alanina y glutamina**. La glutamina es el alimento principal de los enterocitos y del sistema inmune.
