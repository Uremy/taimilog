...
// 1. DEFINICIÓN DEL LOGO (Separado para limpieza)
export const logo = (
...
// 2. DEFINICIÓN DE LINKS (Datos puros, incluyendo los SVGs inline)
export const linkItems: LinkItemType[] = [
  ...
  // --- Redes Sociales (Iconos Inline estilo Fuma) ---
  {
    type: 'icon',
    text: 'GitHub',
    label: 'GitHub',
...
// 3. FUNCIÓN PRINCIPAL (Ahora super limpia ✨)
